...
void transform(unsigned char*frame, int up, int right,int clockwise,bool mx,bool my, int height,int width, struct non_white_data* data_array, int id, int loop){
    ...
    if (loop!=0){
        ...
        if (clockwise){
            ...
            case 1:
                if (mx){
                  for (; temp < limit; temp +=8) {
                        ...
                        x2 = w1-data->row+up; y1 = hh-data->col-right;
                    ...
                    for (; temp < limit; temp +=8) {
                        ...
                        data = temp;       x2 = data->row - up;     y1 = data->col + right;   //   x2 = x1;  
                    ...
                    for (; temp < limit; temp +=8) {
                        ...
                        data = temp;      // y1 = data->row - up;     x1 = data->col + right;      x2 = x1;  
                        ...
                        x2 = w1-data->row+up; y1 = data->col + right;
                ...
                if (mx){
                  for (; temp < limit; temp +=8) {
                    ...
                    for (; temp < limit; temp +=8) {
                        ...
                        data = temp;       //y1 = data->row - up;     x2 = data->col + right;   //   x2 = x1;  
                        ...
                        x2 = data->col + right ; y1 = hh-data->row + up;
                    ...
                    for (; temp < limit; temp +=8) {
                        ...
                        x2 = w1-data->col-right ; y1 = hh-data->row + up;
            ...
            case 3:
                if (mx){
                  for (; temp < limit; temp +=8) {
                        ...
                        data7 = temp+6;    //k1 = data7->row - up;    l1 = data7->col + right;     l2 = l1; 
                        data8 = temp+7;    //m1 = data8->row - up;    n1 = data8->col + right;     n2 = n1;
                        x2 = data->row - up; y1 = data->col+right; 
                    ...
                    for (; temp < limit; temp +=8) {
                        ...
                        x2 = data->row-up;  y1 = hh-data->col - right; 
            ...
            for (; temp < limit; temp +=8) {
                data = temp;       y1 = hh- data->row + up;     x2 = data->col + right;      //x2 = x1;  
            ...
            for (; temp < end; temp ++){
                data = temp;
                y1 = hh- data->row + up;     x2 = data->col + right;                data->row = y1;
                data->col = x2;
                data->row = y1;
                r_frame[y1*width + x2] = data->c;
            }
            ...
            for (; temp < limit; temp +=8) {
                data = temp;       y1 = data->row - up;     x2 = w1-data->col - right;    //  x2 = x1;  
            ...
            for (; temp < end; temp ++){
                data = temp;
                y1 = data->row - up;     x2 = w1-data->col - right;
                data->row = y1;
                data->col = x2;
                r_frame[y1*width + x2] = data->c;
            }
        ...
        ;
            ...
            for (; temp < end; temp ++){
                ...
                y1 = hh- data->row + up;     x2 = data->col + right;            
                data->row = y1;
